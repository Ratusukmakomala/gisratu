document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://raw.githubusercontent.com/Ratusukmakomala/gisratu/chapter2/point.json") // Ganti "point.json" dengan nama file JSON Anda
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://raw.githubusercontent.com/Ratusukmakomala/gisratu/chapter2/polygon.json") // Ganti "point.json" dengan nama file JSON Anda
        .then(response => response.json())
        .then(data => {
            let rowNum = 1; // Nomor urut awal
            data.features.forEach(feature => {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://raw.githubusercontent.com/Ratusukmakomala/gisratu/chapter2/linestring.json") // Ganti "point.json" dengan nama file JSON Anda
        .then(response => response.json())
        .then(data => {
            let rowNum = 1; // Nomor urut awal
            data.features.forEach(feature => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const drawpointSource = new ol.source.Vector({
        url: 'https://raw.githubusercontent.com/Ratusukmakomala/gisratu/chapter2/point.json',
        format: new ol.format.GeoJSON()
    });

    const lineStringSource = new ol.source.Vector({
        url: 'https://raw.githubusercontent.com/Ratusukmakomala/gisratu/chapter2/linestring.json',
        format: new ol.format.GeoJSON()
    });

    const polylineSource = new ol.source.Vector({
        url: 'https://raw.githubusercontent.com/Ratusukmakomala/gisratu/chapter2/polygon.json',
        format: new ol.format.GeoJSON()
    });
